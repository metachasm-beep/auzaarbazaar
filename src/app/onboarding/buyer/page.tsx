...
import { ShieldCheck, ArrowLeft, Building2, MapPin, Hash, Phone, ChevronRight, Loader2 } from 'lucide-react';
...
export default function BuyerRegistrationPage() {
    ...
    return (
        <main className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-6 text-slate-800">
            ...
            <div className="fixed top-0 left-0 w-full h-1 bg-indigo-500 z-50 shadow-sm shadow-indigo-200" />
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-50 rounded-full -mr-80 -mt-80 blur-3xl opacity-30" />
            ...
            <div className="w-full max-w-2xl relative z-10">
                ...
                <div className="mb-10 flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Buyer Profile Registry</h1>
                        <p className="text-slate-500 font-medium">Complete your business procurement profile.</p>
                    </div>
                </div>
                ...
                <p className="mt-8 text-center text-xs font-bold text-slate-400 leading-relaxed max-w-md mx-auto">
                    Your data is secured with industrial encryption. By registering, you gain access to AuzaarBazaar's smart sourcing network.
                </p>
            </div>
        </main>
    );
