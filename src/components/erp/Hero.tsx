                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-16">
                    <div className="flex flex-col justify-center lg:col-span-6">
                        <div className="inline-flex items-center gap-2 rounded-full bg-industrial-blue/5 px-4 py-1.5 text-sm font-semibold text-industrial-blue mb-6 w-fit">
                            <Database size={16} />
                            <span>Modern Industrial ERP</span>
                        </div>
                        <h1 className="text-4xl font-bold tracking-tight text-slate-grey sm:text-6xl mb-6">
                            Scalable <span className="text-industrial-blue">ERP Implementation for Manufacturing</span> Excellence.
                        </h1>
                        <h2 className="text-lg leading-8 text-slate-grey-light mb-10 max-w-xl font-normal">
                            Modernize your shop floor with automated production cycles and real-time inventory tracking designed specifically for the Indian machine tool industry.
                        </h2>
                        <div className="flex flex-wrap gap-4">
                            <button className="inline-flex items-center gap-2 rounded-industrial bg-industrial-blue px-6 py-3.5 text-sm font-semibold text-white shadow-xl hover:bg-industrial-blue-dark transition-all transform hover:-translate-y-0.5">
                                Start ERP Discovery
                                <ArrowRight size={18} />
                            </button>
                            <button className="inline-flex items-center gap-2 rounded-industrial border-2 border-slate-200 bg-transparent px-6 py-3.5 text-sm font-semibold text-slate-grey hover:bg-slate-50 transition-all">
                                View Case Studies
                            </button>
                        </div>
                        ...
                        <div className="mt-12 grid grid-cols-3 gap-8 border-t border-slate-100 pt-10">
                            <div>
                                <p className="text-2xl font-bold text-slate-grey">98%</p>
                                <p className="text-xs text-slate-grey-light uppercase tracking-wider font-semibold">Uptime Increase</p>
                            </div>
                            <div>
                                <p className="text-2xl font-bold text-slate-grey">40%</p>
                                <p className="text-xs text-slate-grey-light uppercase tracking-wider font-semibold">Cost Reduction</p>
                            </div>
                            <div>
                                <p className="text-2xl font-bold text-slate-grey">15+</p>
                                <p className="text-xs text-slate-grey-light uppercase tracking-wider font-semibold">Expert Consultants</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="relative grid grid-cols-2 gap-4">
                                <div className="space-y-4">
                                    <div className="h-48 rounded-xl bg-white p-4 shadow-sm border border-slate-100 flex flex-col justify-between">
                                        <BarChart3 className="text-industrial-blue" size={32} />
                                        <div>
                                            <div className="h-2 w-16 bg-slate-100 rounded mb-2"></div>
                                            <div className="h-2 w-24 bg-industrial-blue/20 rounded"></div>
                                        </div>
                                    </div>
                                    <div className="h-32 rounded-xl bg-industrial-blue p-4 shadow-sm">
